...
<head>
    <meta charset="UTF-8">
    <title>Tambah Produk Ice Cream</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css">
</head>
<body class="bg-gray-100">

    <div class="max-w-4xl mx-auto mt-10 bg-white shadow-md rounded-lg p-6">
        <h2 class="text-2xl font-bold mb-6">Tambah Produk Ice Cream</h2>

        <form action="{{ route('create.iceCream') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex justify-end">
                <a href="{{ route('stok.index', ['category' => 'ice_cream']) }}" 
